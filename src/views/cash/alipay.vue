	...
	<div class="app-container">
		<div class="filter-container">
			...
			<el-table :data="tableData" border style="width: 100%" class="taba">
				<el-table-column prop="aliPayName" label="支付宝名" width="140"></el-table-column>
				<el-table-column prop="realName" label="真实姓名" width="140"></el-table-column>
				<el-table-column prop="aliPayAccount" label="支付宝账户" width="140"></el-table-column>
				<el-table-column prop="money" label="钱数" width="140"></el-table-column>
				<el-table-column prop="phone" label="手机号" width="140"></el-table-column>
				<el-table-column prop="createTime" label="创建时间" width="140"></el-table-column>
				<el-table-column prop="companyName" label="公司名" width="140"></el-table-column>
				<el-table-column prop="nickname" label="昵称" min-width="140"></el-table-column>
				<el-table-column prop="state" label="状态" :formatter="cashState" width="140"></el-table-column>
