...
export default {
    ...
    // 审核前的数据获取
		getInfo() {
			...
			this.loading = true;
			this.Axios.post(this.url + "controller/appadmincontroller/getappuserdesigndarenlist", parmas)
				.then(res => {
					this.loading = false;
    ...
    // 审核后的数据获取
		...
		sendData(){
			...
			var parmas = {
        		...
        		appUserDesigndarenId: this.goodsExamineIdchange
			}
			this.Axios.post(this.url + "controller/appadmincontroller/updateappuserdesigndarenstate", parmas)
				.then(res => {
